...
(
  ...
  COMMENT = 'ライド情報テーブル';
ALTER TABLE `rides` ADD INDEX `chair_id_idx` (`chair_id`, `created_at`); 
ALTER TABLE `rides` ADD INDEX `user_id_and_created_at_idx` (`user_id`, `created_at`); 
...
ALTER TABLE `ride_statuses` ADD INDEX `ride_id_and_created_at_idx` (`ride_id`, `created_at` DESC);
...
(
  ...
  COMMENT 'クーポンテーブル';
  ALTER TABLE `coupons` ADD INDEX `user_id_idx` (`user_id`);
